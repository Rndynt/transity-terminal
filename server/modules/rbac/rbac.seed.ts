...
const ROLES = [
  ...
  { id: "driver",         name: "Driver",          description: "Pengemudi — akses driver app; akses terminal opsional per kebijakan" },
];
...
const FEATURE_FLAGS = [
  ...
  { id: "master.trips.delete",  name: "Hapus Trip",             description: "Hapus trip (satuan maupun massal)",   category: "master" },
  ...
  { id: "access.terminal",   name: "Akses Terminal",    description: "Boleh login ke aplikasi terminal (web)",     category: "access" },
  { id: "access.driver_app", name: "Akses Driver App",  description: "Boleh login ke aplikasi driver (mobile)",    category: "access" },
];

type RoleId = "owner" | "finance" | "manager" | "spv_operations" | "operations" | "spv_cso" | "cso" | "driver";
type FlagMatrix = Record<RoleId, boolean>;

const DEFAULT_MATRIX: Record<string, FlagMatrix> = {
  "page.cso":       { owner: true,  finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: true, driver: false },
  "page.cargo":     { owner: true,  finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: true,  cso: true, driver: false },
  "page.bookings":  { owner: true,  finance: true,  manager: true,  spv_operations: true,  operations: false, spv_cso: true,  cso: false, driver: false },
  "page.schedule":  { owner: true,  finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: false, cso: false, driver: false },
  "page.spj":       { owner: true,  finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: false, cso: false, driver: false },
  "page.manifest":  { owner: true,  finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: true,  cso: true, driver: true },
  "page.reports":   { owner: true,  finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "page.masters":   { owner: true,  finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "report.revenue":            { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "report.sales":              { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "report.trip_profitability": { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "report.load_factor":        { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "report.cancellations":      { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "report.cargo":              { owner: true, finance: true,  manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "report.payments":           { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "report.commercial_fee":    { owner: true, finance: true,  manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "master.stops":          { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.outlets":        { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.vehicles":       { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.drivers":        { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.layouts":        { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.trip_patterns":  { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.trips":          { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.trips.delete":  { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.price_rules":    { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.promos":         { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.cargo_types":    { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.cargo_rates":    { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "master.cost_templates": { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "action.booking.create":        { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: true, driver: false },
  "action.booking.cancel":        { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: true, driver: false },
  "action.passenger.unseat":      { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: false, driver: false },
  "action.passenger.reschedule":  { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: false, driver: false },
  "action.passenger.assign_seat": { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: true, driver: false },
  "action.trip.materialize":      { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "action.inventory.initialize":  { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "action.trip.close":            { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "action.trip.batch_reschedule": { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "page.schedule.closed":        { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "page.cso.view_closed":        { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "action.payment.create":        { owner: true, finance: false, manager: true,  spv_operations: false, operations: false, spv_cso: true,  cso: true, driver: false },
  "action.cargo.create":          { owner: true, finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: true,  cso: true, driver: false },
  "action.cargo.manage":          { owner: true, finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: false, cso: false, driver: false },
  "action.spj.create":            { owner: true, finance: false, manager: true,  spv_operations: true,  operations: true,  spv_cso: false, cso: false, driver: false },
  "action.spj.issue":             { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },
  "action.spj.settle":            { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: false },

  "page.dashboard":   { owner: true, finance: true,  manager: true,  spv_operations: true,  operations: false, spv_cso: true,  cso: false, driver: true },
  ...
  "action.refund.process": { owner: true, finance: true,  manager: true,  spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "action.cso.cross_outlet": { owner: true, finance: false, manager: true, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "admin.staff.manage": { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },
  "admin.flags.manage": { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false, driver: false },

  "access.terminal":   { owner: true, finance: true,  manager: true,  spv_operations: true,  operations: true,  spv_cso: true,  cso: true,  driver: false },
  "access.driver_app": { owner: true, finance: false, manager: true,  spv_operations: true,  operations: false, spv_cso: false, cso: false, driver: true  },
};
