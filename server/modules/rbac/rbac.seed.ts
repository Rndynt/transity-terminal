...
const DEFAULT_MATRIX: Record<string, FlagMatrix> = {
  ...
  "master.trips.delete":  { owner: true, finance: false, manager: false, spv_operations: false, operations: false, spv_cso: false, cso: false },
