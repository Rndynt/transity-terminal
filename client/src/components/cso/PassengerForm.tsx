...
export default function PassengerForm({
  ...
  return (
    <div className="h-full flex flex-col gap-0 overflow-hidden">
      ...
      {/* ── Round-trip mode: bottom action bar ── */}
      {isRoundTrip && (
        <div className="flex-shrink-0 px-3 md:px-5 py-3 border-t border-gray-100 bg-white flex gap-2">
          <button
            onClick={onBack}
            className="h-10 px-4 bg-gray-100 text-gray-600 rounded-xl font-semibold text-sm hover:bg-gray-200 transition-colors"
